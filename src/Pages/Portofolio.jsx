...
// Local certificate images from public/certificates folder
...
// Local project data (replace with your actual project data)
const localProjects = [
  {
    id: 1,
    ...
    Features: [ // Example features for Smart Cookie
      "Real-time student-teacher reward program",
      "Point-based system for achievements",
      "Fosters motivation and engagement",
      "Zero-cost online rewards engine"
    ]
  },
  {
    id: 2,
...
const techStacks = [
  ...
  { icon: "mongodb-png.png", language: "Mongo DB" },
  { icon: "express-js.png", language: "ExpressJS" },
...
export default function FullWidthTabs() {
  ...
  useEffect(() => {
    ...
    // Store localProjects in localStorage when the component mounts
