    ...
    <div className="relative group" data-aos="fade-up" data-aos-duration="1000">
      ...
      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
          ...
          <img
            src={mine} // Change this to your image path
            alt="Profile"
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I'm a 4th-year Computer Science student at Teegala Krishna Reddy Engineering College with a passion for technology and graphic design. As a React and Node.js developer at Blue Planet Info Solution, I craft innovative full-stack solutions using Java, JavaScript, and database technologies. I've built practical web apps like an internship portal and club management system. Beyond coding, I enjoy geopolitics and travel, and I'm committed to continuous learning and staying current with emerging tech.</p>
